...
import bg_image from '../assets/team-01.webp'
import one from '../assets/doc-01.webp'
import two from '../assets/doc-02.webp'
import three from '../assets/doc-03.webp'
import four from '../assets/doc-04.webp'
import five from '../assets/doc-05.webp'
import six from '../assets/doc-06.webp'
  ...
  return (
    <div className="flex flex-col border border-solid border-[#dcdfe5]">
      <div className="w-full h-93 md:h-80 lg:h-90 overflow-hidden">
        <img src={hisimg} alt={doctorname} className="block w-full h-full object-cover" loading="lazy" />
      </div>
